...
const uint64_t MONEY_SUPPLY = UINT64_C(858986905600000001)     = ;
const unsigned EMISSION_SPEED_FACTOR = 21                      = 18;
...
const uint64_t DIFFICULTY_TARGET = 120                       = 120; // seconds
...
const char     CRYPTONOTE_NAME[]="Ultra High Coin"           = "";
